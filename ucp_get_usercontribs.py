...
#利用者の投稿履歴を調べる
user = 'かぼ'
PARAM = {'action':'query','format':"json",'list':"usercontribs","ucuser":user,'uclimit':500}
...
#以下の記事空間に属する記事は取り除く
PATTERN_LIST = ['ファイル:.*','ファイル・トーク:.*','利用者:.*','利用者・トーク:.*','MediaWiki:.*','Game talk:.*','トーク:.*','テンプレート:.*','テンプレート・トーク:.*','カテゴリ:.*','UnBooks talk:.*','日記/過去ログ/.*','Forum:.*','Forum talk:.*','Uncyclopedia:.*','Uncyclopedia・トーク:.*','Portal:.*','Portal talk:.*','ヘルプ:.*','ヘルプ・トーク:.*','UnNews:バ科ニュース.*','UnNews:訃報.*']
result_new_pages = []
